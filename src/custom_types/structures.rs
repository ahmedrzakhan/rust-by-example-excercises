...
// returns a Rectangle with its top left corner on the point, and a width
// and height corresponding to the f32.
...
fn main() {
    ...
    let get_square = square(point, point.x);
    println!("get_square: {:?}", get_square)
}
